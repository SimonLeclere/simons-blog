...
export function Table(props: Readonly<ComponentPropsWithoutRef<'table'>>) {
  return (
...
export function Thead(props: Readonly<ComponentPropsWithoutRef<'thead'>>) {
  return <thead className="border-b border-gray-200 dark:border-zinc-800 bg-gray-50 dark:bg-zinc-900" {...props} />
}

export function Th(props: Readonly<ComponentPropsWithoutRef<'th'>>) {
  return <th className="px-4 py-3 font-semibold text-gray-900 dark:text-gray-100" {...props} />
}

export function Td(props: Readonly<ComponentPropsWithoutRef<'td'>>) {
